...
public class BranchSelectActivity extends BaseAppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (isInternetPresent) {
            ...
            alert.showAlertDialog(BranchSelectActivity.this, "Connection failed..", "Please Check Your Internet Connectivity", false);
        }
    }
    ...
    public void onResponseListener(Object responseModel) {
        ...
        if (responseModel != null) {
            ...
            if (loginResponse != null && loginResponse.getAllUsersList() != null) {
                ...
                startActivity(new Intent(BranchSelectActivity.this, BottomNavigationActivity.class));
            }
        }
    }
